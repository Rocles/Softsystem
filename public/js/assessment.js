...
if (!form) {
  ...
  const candidateNameInput = qs("candidateName");
  const candidateEmailInput = qs("candidateEmail");
  const applicationIdInput = qs("applicationId");
  ...
  if (emailFromUrl) candidateEmailInput.value = emailFromUrl;
  if (nameFromUrl) candidateNameInput.value = nameFromUrl;
  if (appIdFromUrl) applicationIdInput.value = appIdFromUrl;
